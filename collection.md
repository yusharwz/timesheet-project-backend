...
### Method: GET
>```
>{{base}}/admin/works?paging=2&rowsPerPage=2&description=mengajar
>```
### Query Params
...
> [!NOTE]
> 
> get all timesheet even the work is deleted
...
### Method: GET
>```
>{{base}}/admin/accounts?paging=2&rowsPerPage=2&name=aku
>```
### Query Params
